...
{
    public class GetListNotifyByUserIdHandler : IRequestHandler<GetListNotifyByUserId, HandlerResult<IEnumerable<Notify>>>
    {
        ...
        public async Task<HandlerResult<IEnumerable<Notify>>> Handle(GetListNotifyByUserId request, CancellationToken cancellationToken)
        {
